var arrOfImages = ["AwkwafinaMatch.jpeg", "BritneyMatch.jpeg", "ChrisEMatch.jpeg", "ChrisHMatch.jpeg", "ChristinaMatch.jpeg", "HenryMatch.jpeg", "IdrisMatch.jpeg", "LupitaMatch.jpeg", "SandraMatch.jpg", "MandyMoreMatch.jpg"];
...
function displayCards(arr) {
    ...
    for (var i = 0; i < arr.length; i++) {
        ...
        newImgElement.src = "memory/static/images/" + arr[i];
...
function hideACard(idx) {
    ...
    specificCard.src = "memory/static/images/questionmark.png";
}
...
function revealCard(event) {
    ...
    clickedImage.src = "memory/static/images/" + arrOfImages[clickedImageId];
